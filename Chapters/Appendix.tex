...
\begin{figure}[hp]
				\centering
				\includegraphics[scale=1.0, width=170mm]{Images/iCIMS-Tracking-List-Cropped}
				\caption{Patient Tracking List}
\end{figure} 

\vspace{-10mm}

\subsubsection{Very Uncomplex Patient Handover}
\label{Very Uncomplex Patient}

\begin{figure}[hp]
				\centering
				\includegraphics[scale=1.0, width=148mm]{Images/iCIMS-Very-Uncomplex-Patient}
				\caption{Patient Tracking List}
\end{figure} 
...
\begin{figure}[hp]
				\centering
				\includegraphics[scale=1.0, width=120mm]{Images/iCIMS-Medium-Patient}
				\caption{Patient Tracking List}
\end{figure} 
...
\begin{figure}[hp]
				\centering
				\includegraphics[scale=1.0, width=123mm]{Images/iCIMS-Complex-Patient}
				\caption{Patient Tracking List}
\end{figure} 
...
\begin{figure}[hp]
				\centering
				\includegraphics[scale=1.0, width=123mm]{Images/iCIMS-General-Patient-Information}
				\caption{Patient Tracking List}
\end{figure} 
...
The following sections outline work flows within SANSURGIMS based on forms.
